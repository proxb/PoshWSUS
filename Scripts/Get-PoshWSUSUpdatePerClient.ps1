function Get-PoshWSUSUpdatePerClient {
    <#  
    .SYNOPSIS  
    ...
    .NOTES  
        Name: Get-PoshWSUSUpdatePerComputer
        Author: Boe Prox
    ...
    .EXAMPLE    
    Get-PoshWSUSUpdatePerClient -UpdateScope (New-PoshWSUSUpdateScope -IncludedInstallationStates Failed)
    ...
    .EXAMPLE
    Get-PoshWSUSUpdatePerClient -Computername Test1 -UpdateScope (New-PoshWSUSUpdateScope -IsWsusInfrastructureUpdate)
    ...
    Process {
        If ($PSBoundParameters['ComputerName']) {
            $hash['ComputerObject'] = Get-PoshWSUSClient -Computer $Computername
        } ElseIf ($PSBoundParameters['ComputerObject']) {
            $hash['ComputerObject'] = $ComputerObject
        } Else {
            $hash['ComputerObject'] = Get-PoshWSUSClient
        }
