function Get-PoshWSUSClientPerUpdate {
    <#  
    .SYNOPSIS  
    ...
    .NOTES  
        Name: Get-PoshWSUSClientPerUpdate
        Author: Boe Prox
    ...
    .EXAMPLE
        Get-PoshWSUSClientPerUpdate -GroupName Servers -Update 935490 
    ...
    .EXAMPLE
        $scope = New-PoshWSUSComputerScope -NameIncludes "V" -FromLastSyncTime (Get-Date).AddDays(-14)
        Get-PoshWSUSClientPerUpdate -ComputerScope $scope -Update 935490
    ...
    Process {
        If ($PSBoundParameters['Update'] -is [string] -OR $PSBoundParameters['Update'] -is [int]) {
            ...
            $hash['UpdateObject'] = Get-PoshWSUSUpdate -Update $Update
        ...
        If ($PSBoundParameters['GroupName']) {
            ...
            $hash['GroupObject'] = Get-PoshWSUSGroup -Name $GroupName
