function Remove-PoshWSUSGroup {
    ...
    .EXAMPLE 
    Remove-PoshWSUSGroup  -name "Domain Servers"

    Description
    -----------  
    This command will remove the Domain Servers WSUS Target group.  
    .EXAMPLE 
    Remove-PoshWSUSGroup  -id "fc93e74e-ba59-4593-9ff7-690af1be695f"
