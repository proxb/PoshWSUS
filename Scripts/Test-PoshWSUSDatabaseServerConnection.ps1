Function Test-PoshWSUSDatabaseServerConnection {
    <#  
    .SYNOPSIS  
    ...
    .DESCRIPTION
        Tests the database connection from the console to the SQL database hosting the WSUS database.
    .NOTES  
        Name: Test-PoshWSUSDatabaseServerConnection
        Author: Boe Prox
    ...
    Process {
        If ($wsusdb) {
            ...
            Write-Warning "Please connect to the database first using Connect-PoshWSUSDatabaseServer"
        }
    }   
}
