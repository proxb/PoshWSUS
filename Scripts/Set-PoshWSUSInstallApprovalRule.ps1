Function Set-PoshWSUSInstallApprovalRule {
    <#  
    .SYNOPSIS  
    ...
    .PARAMETER Categories
        Collection of categories that will be applied to the rule. Use Get-PoshWSUSUpdateCategories to gather the collection.
        
    .PARAMETER Group
        Collection of Computer Target Groups that will be applied to the rule.  Use Get-PoshWSUSGroups to gather the collection.
        
    .PARAMETER Classifications 
        Collection of Update Classifications that will be applied to the rule.  Use Get-PoshWSUSUpdateClassifications for the collection.
    ...
    .NOTES  
        Name: New-PoshWSUSInstallApprovalRule
        Author: Boe Prox
    ...
    .EXAMPLE  
    Set-PoshWSUSInstallApprovalRule -Name "Rule1" -Enable
    ...
    .EXAMPLE  
    Set-PoshWSUSInstallApprovalRule -Name "Rule1" -Disable
    ...
    .EXAMPLE  
    $cat = Get-PoshWSUSUpdateCategories | ? {$_.Title -eq "Windows Server 2008"}
    $group = Get-PoshWSUSGroups | ? {$_.Name -eq "Test"}
    $class = Get-PoshWSUSUpdateClassifications | ? {$_.Title -eq "Updates"}
    Set-PoshWSUSInstallApprovalRule -Name "Rule1" -Category $cat -Classification $class -Group $group
