function Get-PoshWSUSInstallableItem {
    <#  
    .SYNOPSIS  
    ...
    .NOTES  
        Name: Get-PoshWSUSInstallableItem 
        Author: Boe Prox
    ...
    .EXAMPLE  
    Get-PoshWSUSInstallableItem -UpdateName 2617986
    ...
    .EXAMPLE
    Get-PoshWSUSUpdate -Update 2607712 | Get-PoshWSUSInstallableItem | Format-Table
    ...
    Description
    -----------
    Example showing that Get-PoshWSUSInstallableItem accepts the pipleline result from Get-PoshWSUSUpdate to locate the installable items.
    #> 
    [cmdletbinding(
