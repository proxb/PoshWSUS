function Get-PoshWSUSUpdateSummaryPerGroup {
    <#  
    .SYNOPSIS  
    ...
    .NOTES  
        Name: Get-PoshWSUSUpdateSummaryPerGroup
        Author: Boe Prox
    ...
    .EXAMPLE    
    Get-PoshWSUSUpdateSummaryPerGroup -UpdateName 2617986 
    ...
    .EXAMPLE
    Get-PoshWSUSUpdateSummaryPerGroup -UpdateName 2617986 -GroupName Group1
    UpdateTitle                         ComputerGroup             InstalledCount  NeededCount       FailedCount
    -----------                         -------------             --------------  ----------------- -----------
    ...
    Process {
        If ($PSBoundParameters['UpdateName']) {
            $hash['UpdateObject'] = Get-PoshWSUSUpdate -Update $UpdateName
        } Else {
