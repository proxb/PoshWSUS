Function Remove-PoshWSUSInstallApprovalRule {
    <#  
    .SYNOPSIS  
    ...
    .NOTES  
        Name: Remove-PoshWSUSInstallApprovalRule
        Author: Boe Prox
    ...
    .EXAMPLE  
    Remove-PoshWSUSInstallApprovalRule -name "Rule1"

    Description
    -----------      
    Removes Rule1 from WSUS      
    .EXAMPLE  
    $rule = Get-PoshWSUSInstallApprovalRule | Where {$_.Name -eq "Rule1"}
    $rule | Remove-PoshWSUSInstallApprovalRule
