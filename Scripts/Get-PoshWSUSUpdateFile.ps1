function Get-PoshWSUSUpdateFile {
    <#  
    .SYNOPSIS  
    ...
    .EXAMPLE  
    Get-PoshWSUSUpdateFile -UpdateName 2617986
    ...
    .EXAMPLE
    Get-PoshWSUSUpdate -Update 2617986 | Select -First 1 | Get-PoshWSUSInstallableItem | Select -First 1  | Get-PoshWSUSUpdateFile
    ...
    Description
    -----------
    Accepts pipeline input using Get-PoshWSUSUPdate and Get-PoshWSUSInstallable Item to list the files that are used by the update.
