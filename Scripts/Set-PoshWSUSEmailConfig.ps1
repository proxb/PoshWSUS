function Set-PoshWSUSEmailConfig {
    <#  
    .SYNOPSIS  
    ...
    .EXAMPLE  
    Set-PoshWSUSEmailConfig -SenderDisplayName "WSUSAdmin" -SenderEmailAddress "wsusadmin@domain.com"
