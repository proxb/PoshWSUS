Function Start-PoshWSUSInstallApprovalRule {
    <#  
    .SYNOPSIS  
    ...
    .PARAMETER InputObject
        Rule object to run       
    .NOTES  
        Name: Start-PoshWSUSInstallApprovalRule
        Author: Boe Prox
    ...
    .EXAMPLE  
    Start-PoshWSUSInstallApprovalRule -Name "Rule1"
    ...
    .EXAMPLE
    $rule = Get-PoshWSUSInstallApprovalRules | Where {$_.Name -eq "Rule1"}  
    $rule | Start-PoshWSUSInstallApprovalRule
